        ...
        <div className="reg-card">
          ...
          >
            <svg width="22" height="22" viewBox="0 0 35 33" fill="none">
              <path d="M32.958.5L19.535 10.585l2.454-5.794L32.958.5Z" fill="#E17726" />
              <path d="M2.042.5l13.312 10.18-2.34-5.89L2.042.5Z" fill="#E27625" />
              <path d="m21.886 14.257-2.18 3.289 7.77.353-.258-8.354-5.332 4.712Z" fill="#E27625" />
              <path d="m13.1 14.257-5.4-4.807-.176 8.449 7.756-.353-2.18-3.289Z" fill="#E27625" />
              <path d="m15.796 21.913-3.872-1.141 2.74-1.251 1.132 2.392Z" fill="#233447" />
              <path d="m19.19 21.913 1.131-2.392 2.754 1.251-3.885 1.141Z" fill="#233447" />
              <path d="m19.245 31.026.041-1.318-.353-.298h-5.237l-.326.298.027 1.318-4.321-2.093 1.511 1.236 3.06 2.12h5.265l3.074-2.12 1.497-1.236-4.238 2.093Z" fill="#C0AC9D" />
              <path d="M33.52 11.12 34.5.5l-1.542-.5-12.573 9.338 4.83 4.077 6.826 1.993 1.51-1.764-.652-.475 1.037-.95-.803-.62 1.037-.798-.65-.482Z" fill="#763E1A" />
              <path d="M.5.5l.98 10.62-.625.46 1.037.798-.789.62 1.023.95-.651.475 1.496 1.764 6.826-1.993 4.83-4.077L1.055 0 .5.5Z" fill="#763E1A" />
              <path d="m31.94 15.408-6.826-1.993 2.194 3.13-3.264 6.348 4.307-.054h6.267l-2.678-7.43Z" fill="#F5841F" />
              <path d="M8.872 13.415l-6.84 1.993-2.637 7.43h6.253l4.293.054-3.25-6.348 2.181-3.13Z" fill="#F5841F" />
            </svg>
